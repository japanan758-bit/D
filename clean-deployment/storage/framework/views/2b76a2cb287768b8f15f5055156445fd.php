...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'خدماتنا الطبية','description' => 'خدمات شاملة ومتخصصة في طب العيون - جراحات الشبكية والمياه البيضاء']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'خدماتنا الطبية','description' => 'خدمات شاملة ومتخصصة في طب العيون - جراحات الشبكية والمياه البيضاء']); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <p class="text-xl text-blue-100 max-w-3xl mx-auto">
                <?php echo e(__('نقدم مجموعة شاملة من الخدمات المتخصصة في طب العيون بأعلى معايير الجودة')); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                <?php echo e(__('خطوات بسيطة لحجز موعدك مع د. عبدالناصر الأخصور')); ?>
...
<section class="py-20 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-3xl lg:text-4xl font-bold mb-6"><?php echo e(__('احجز موعدك الآن')); ?></h2>
        <p class="text-xl text-blue-100 mb-8">
            <?php echo e(__('لا تتردد في حجز موعدك مع د. عبدالناصر الأخصور للحصول على أفضل رعاية طبية')); ?>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://wa.me/966123456789" target="_blank"
               class="border-2 border-white text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors">
                <?php echo e(__('تواصل عبر واتساب')); ?>
...
<?php endif; ?><?php /**PATH /workspace/final-project/resources/views/pages/services.blade.php ENDPATH**/ ?>