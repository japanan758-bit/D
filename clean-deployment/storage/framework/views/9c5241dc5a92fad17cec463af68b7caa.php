...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'المدونة الطبية','description' => 'مقالات طبية شاملة ومفيدة حول صحة العيون من د. عبدالناصر الأخصور']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'المدونة الطبية','description' => 'مقالات طبية شاملة ومفيدة حول صحة العيون من د. عبدالناصر الأخصور']); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <p class="text-xl text-blue-100 max-w-3xl mx-auto">
                <?php echo e(__('مقالات طبية شاملة ومفيدة من د. عبدالناصر الأخصور حول صحة العيون والعناية بها')); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <div class="p-8 lg:p-12">
                    ...
                    <h3 class="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
                        <?php echo e(__('أحدث التطورات في علاج الشبكية 2025')); ?>

                    </h3>
                    <p class="text-gray-600 mb-6 leading-relaxed">
                        <?php echo e(__('يتحدث د. عبدالناصر الأخصور في هذا المقال عن أحدث التطورات والتقنيات المتقدمة في علاج أمراض الشبكية، بما في ذلك العلاجات الجينية والعلاج بالخلايا الجذعية.')); ?>
                    ...
                    <a href="#" class="inline-flex items-center bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                        <?php echo e(__('اقرأ المقال كاملاً')); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <article class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3 hover:text-blue-600 cursor-pointer">
                        <?php echo e(__('أسباب تكون المياه البيضاء والوقاية منها')); ?>

                    </h3>
                    <p class="text-gray-600 mb-4 leading-relaxed">
                        <?php echo e(__('مقال شامل يشرح الأسباب الرئيسية لتكون المياه البيضاء وكيفية الوقاية منها عبر نمط حياة صحي وفحوصات دورية.')); ?>
            ...
            <article class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3 hover:text-blue-600 cursor-pointer">
                        <?php echo e(__('الفاحص الضوئي المقطعي: تقنيات متقدمة')); ?>

                    </h3>
                    <p class="text-gray-600 mb-4 leading-relaxed">
                        <?php echo e(__('كيف يعمل جهاز OCT وأهميته في تشخيص أمراض الشبكية بدقة عالية وبدون ألم للمريض.')); ?>
            ...
            <article class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3 hover:text-blue-600 cursor-pointer">
                        <?php echo e(__('أهمية الفحوصات الدورية للعيون')); ?>

                    </h3>
                    <p class="text-gray-600 mb-4 leading-relaxed">
                        <?php echo e(__('لماذا يجب إجراء فحوصات العيون بانتظام وكيف يمكن اكتشاف الأمراض مبكراً؟')); ?>
            ...
            <article class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3 hover:text-blue-600 cursor-pointer">
                        <?php echo e(__('عادات يومية تحمي عينيك من الإرهاق')); ?>

                    </h3>
                    <p class="text-gray-600 mb-4 leading-relaxed">
                        <?php echo e(__('نصائح بسيطة يمكن تطبيقها يومياً للحفاظ على صحة العيون ومنع الإرهاق والتعب.')); ?>
            ...
            <article class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3 hover:text-blue-600 cursor-pointer">
                        <?php echo e(__('متى تطلب المساعدة الطبية العاجلة؟')); ?>

                    </h3>
                    <p class="text-gray-600 mb-4 leading-relaxed">
                        <?php echo e(__('علامات التحذير التي تتطلب عناية طبية فورية للحفاظ على صحة بصرية.')); ?>
            ...
            <article class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3 hover:text-blue-600 cursor-pointer">
                        <?php echo e(__('تقنية الفاكو: ثورة في جراحات العيون')); ?>

                    </h3>
                    <p class="text-gray-600 mb-4 leading-relaxed">
                        <?php echo e(__('كيف غيّرت تقنية الفاكو طريقة إجراء جراحات المياه البيضاء وأصبحت المعيار الذهبي.')); ?>
        ...
        <div class="text-center">
            <button class="bg-gray-200 text-gray-700 px-8 py-3 rounded-lg font-semibold hover:bg-gray-300 transition-colors">
                <?php echo e(__('عرض المزيد من المقالات')); ?>
...
<section class="py-20 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-3xl lg:text-4xl font-bold mb-6"><?php echo e(__('اشترك في النشرة الطبية')); ?></h2>
        <p class="text-xl text-blue-100 mb-8">
            <?php echo e(__('احصل على أحدث المقالات والنصائح الطبية مباشرة في بريدك الإلكتروني')); ?>

        </p>
        <form class="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <input type="email" 
                   placeholder="<?php echo e(__('أدخل بريدك الإلكتروني')); ?>"
            ...
            <button type="submit" 
                ...
                <?php echo e(__('اشتراك')); ?>

            </button>
        </form>
        <p class="text-sm text-blue-200 mt-4">
            <?php echo e(__('لن نرسل لك رسائل مزعجة. يمكنك إلغاء الاشتراك في أي وقت.')); ?>
...
<?php endif; ?><?php /**PATH /workspace/final-project/resources/views/pages/blog.blade.php ENDPATH**/ ?>