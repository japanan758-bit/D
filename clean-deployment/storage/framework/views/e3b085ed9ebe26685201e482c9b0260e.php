                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?php $__errorArgs = ['clinic_name'];
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('clinic_name', $settings->clinic_name ?? '')); ?>" required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?php $__errorArgs = ['clinic_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('clinic_phone', $settings->clinic_phone ?? '')); ?>" required>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['clinic_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control <?php $__errorArgs = ['clinic_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('clinic_email', $settings->clinic_email ?? '')); ?>" required>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['clinic_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control <?php $__errorArgs = ['appointment_duration'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('appointment_duration', $settings->appointment_duration ?? 30)); ?>" 
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control <?php $__errorArgs = ['max_appointments_per_day'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('max_appointments_per_day', $settings->max_appointments_per_day ?? 20)); ?>" 
                                   min="1" required>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['max_appointments_per_day'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('whatsapp_number', $settings->whatsapp_number ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control <?php $__errorArgs = ['clinic_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                              id="clinic_address" name="clinic_address" rows="3" required><?php echo e(old('clinic_address', $settings->clinic_address ?? '')); ?></textarea>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['clinic_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="sunday_start" name="working_hours[sunday][start]" 
                                   value="<?php echo e(old('working_hours.sunday.start', $settings->working_hours['sunday']['start'] ?? '09:00')); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="sunday_end" name="working_hours[sunday][end]" 
                                   value="<?php echo e(old('working_hours.sunday.end', $settings->working_hours['sunday']['end'] ?? '17:00')); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="monday_start" name="working_hours[monday][start]" 
                                   value="<?php echo e(old('working_hours.monday.start', $settings->working_hours['monday']['start'] ?? '09:00')); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="monday_end" name="working_hours[monday][end]" 
                                   value="<?php echo e(old('working_hours.monday.end', $settings->working_hours['monday']['end'] ?? '17:00')); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="tuesday_start" name="working_hours[tuesday][start]" 
                                   value="<?php echo e(old('working_hours.tuesday.start', $settings->working_hours['tuesday']['start'] ?? '09:00')); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="tuesday_end" name="working_hours[tuesday][end]" 
                                   value="<?php echo e(old('working_hours.tuesday.end', $settings->working_hours['tuesday']['end'] ?? '17:00')); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="wednesday_start" name="working_hours[wednesday][start]" 
                                   value="<?php echo e(old('working_hours.wednesday.start', $settings->working_hours['wednesday']['start'] ?? '09:00')); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="wednesday_end" name="working_hours[wednesday][end]" 
                                   value="<?php echo e(old('working_hours.wednesday.end', $settings->working_hours['wednesday']['end'] ?? '17:00')); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="thursday_start" name="working_hours[thursday][start]" 
                                   value="<?php echo e(old('working_hours.thursday.start', $settings->working_hours['thursday']['start'] ?? '09:00')); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="thursday_end" name="working_hours[thursday][end]" 
                                   value="<?php echo e(old('working_hours.thursday.end', $settings->working_hours['thursday']['end'] ?? '17:00')); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="friday_start" name="working_hours[friday][start]" 
                                   value="<?php echo e(old('working_hours.friday.start', $settings->working_hours['friday']['start'] ?? '09:00')); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="friday_end" name="working_hours[friday][end]" 
                                   value="<?php echo e(old('working_hours.friday.end', $settings->working_hours['friday']['end'] ?? '17:00')); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="saturday_start" name="working_hours[saturday][start]" 
                                   value="<?php echo e(old('working_hours.saturday.start', $settings->working_hours['saturday']['start'] ?? '')); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" id="saturday_end" name="working_hours[saturday][end]" 
                                   value="<?php echo e(old('working_hours.saturday.end', $settings->working_hours['saturday']['end'] ?? '')); ?>">
                        </div>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('google_maps_url', $settings->google_maps_url ?? '')); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['google_maps_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['google_analytics_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /workspace/final-project/resources/views/admin/settings.blade.php ENDPATH**/ ?>