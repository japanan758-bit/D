...
<head>
    ...
    <title>@yield('title', 'لوحة التحكم') - نظام إدارة العيادة</title>
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="{{ route('admin.medical-records.index') }}" class="sidebar-item {{ request()->routeIs('admin.medical-records.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.messages.index') }}" class="sidebar-item {{ request()->routeIs('admin.messages.*') ? 'active' : '' }}">
    ...
    <div class="main-content" id="mainContent">
        ...
        <header class="admin-header">
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="header-title">@yield('page_title', 'لوحة التحكم')</h1>
                ...
                <div class="header-actions">
                    ...
                    <a href="{{ route('home') }}" class="header-btn" title="زيارة الموقع">
