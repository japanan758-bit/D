...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'الرئيسية','description' => 'عيادة د. عبدالناصر الأخرس - استشاري جراحات الشبكية والمياه البيضاء']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'الرئيسية','description' => 'عيادة د. عبدالناصر الأخرس - استشاري جراحات الشبكية والمياه البيضاء']); ?>
    <!-- Hero Section -->
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="text-center lg:text-right rtl:text-right">
                    <h1 class="text-4xl lg:text-6xl font-bold leading-tight mb-6">
                        <span class="bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">
                            <?php echo e(__('عيادة د. عبدالناصر الأخرس')); ?>

                        </span>
                    </h1>
                    <p class="text-xl lg:text-2xl text-amber-300 mb-6 font-semibold">
                        <?php echo e(__('استشاري جراحات الشبكية والمياه البيضاء')); ?>

                    </p>
                    <p class="text-lg text-blue-100 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                        <?php echo e(__('أكثر من 20 عاماً من الخبرة في جراحات العيون المتقدمة. نستخدم أحدث التقنيات لضمان أفضل النتائج لمرضانا الكرام.')); ?>
                ...
                <div class="hidden lg:block relative">
                    <div class="relative z-10">
                        <img src="<?php echo e(asset('images/doctor-hero.png')); ?>" 
                    ...
                    <div class="absolute -top-4 -right-4 bg-white bg-opacity-95 backdrop-blur-sm rounded-2xl p-4 shadow-xl">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h3 class="text-sm font-bold text-gray-900"><?php echo e(__('20+ عام')); ?></h3>
                                <p class="text-xs text-gray-600"><?php echo e(__('خبرة متخصصة')); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="absolute -bottom-4 -left-4 bg-white bg-opacity-95 backdrop-blur-sm rounded-2xl p-4 shadow-xl">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h3 class="text-sm font-bold text-gray-900"><?php echo e(__('5000+')); ?></h3>
                                <p class="text-xs text-gray-600"><?php echo e(__('عملية ناجحة')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <div class="text-gray-600"><?php echo e(__('عام من الخبرة')); ?></div>
                </div>
                <div class="text-center">
                    ...
                    <div class="text-gray-600"><?php echo e(__('عملية ناجحة')); ?></div>
                </div>
                <div class="text-center">
                    ...
                    <div class="text-gray-600"><?php echo e(__('مريض سعيد')); ?></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-4"><?php echo e(__('خدماتنا الطبية')); ?></h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    <?php echo e(__('نقدم مجموعة شاملة من خدمات طب وجراحة العيون باستخدام أحدث التقنيات والمعدات الطبية المتطورة')); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow p-6">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 mb-2">
                            <?php echo e($service->getTranslation('name', 'ar')); ?>

                        </h3>
                        <p class="text-gray-600 mb-4 leading-relaxed">
                            <?php echo e($service->getTranslation('description', 'ar')); ?>

                        </p>
                        <div class="flex items-center justify-between">
                            <div class="text-2xl font-bold text-blue-600">
                                <?php echo e($service->consultation_fee); ?> <?php echo e(__('جنيه')); ?>

                            </div>
                            <span class="text-sm text-gray-500"><?php echo e($service->duration); ?> <?php echo e(__('دقيقة')); ?></span>
                        </div>
                    </div>
            ...
            <div class="text-center mt-12">
                <a href="<?php echo e(route('services')); ?>" 
                   class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold transition-colors">
                    <?php echo e(__('عرض جميع الخدمات')); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                        <?php echo e(__('د. عبدالناصر الأخرس')); ?>
                    ...
                    <p class="text-gray-600 mb-6 leading-relaxed">
                        <?php echo e(__('د. عبدالناصر الأخرس هو استشاري في جراحات الشبكية والمياه البيضاء مع أكثر من 20 عاماً من الخبرة في هذا المجال. حاصل على بكالوريوس الطب والجراحة وأخصائي طب وجراحة العيون.')); ?>
                    ...
                    <div class="space-y-4 mb-8">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-700"><?php echo e(__('خبرة أكثر من 20 عاماً في جراحات العيون')); ?></span>
                        </div>
                        <div class="flex items-center">
                            <svg class="w-5 h-5 text-green-500 ml-3 rtl:ml-0 rtl:mr-3" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-gray-700"><?php echo e(__('أحدث التقنيات في جراحة العيون')); ?></span>
                        </div>
                        <div class="flex items-center">
                            <svg class="w-5 h-5 text-green-500 ml-3 rtl:ml-0 rtl:mr-3" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-gray-700"><?php echo e(__('رعاية طبية متميزة ومعايير عالية للجودة')); ?></span>
                        </div>
                    </div>
                    <a href="<?php echo e(route('about')); ?>" 
                       class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors">
                        <?php echo e(__('المزيد عن الطبيب')); ?>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-4"><?php echo e(__('آراء مرضانا')); ?></h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    <?php echo e(__('ماذا يقول مرضانا عن تجربتهم معنا')); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl shadow-md p-6">
                        ...
                        <p class="text-gray-600 mb-4 italic">"<?php echo e($testimonial->getTranslation('content', 'ar')); ?>"</p>
                        <div class="border-t pt-4">
                            <div class="font-semibold text-gray-900"><?php echo e($testimonial->getTranslation('patient_name', 'ar')); ?></div>
                            <div class="text-sm text-gray-500"><?php echo e($testimonial->getTranslation('patient_location', 'ar')); ?></div>
                            <div class="text-sm text-blue-600 mt-1"><?php echo e($testimonial->service_name); ?></div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
    ...
    <section class="py-16 bg-blue-600 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl lg:text-4xl font-bold mb-6">
                <?php echo e(__('احجز موعدك الآن')); ?>

            </h2>
            <p class="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                <?php echo e(__('احصل على أفضل رعاية طبية لعيونك مع أحدث التقنيات والخبرة المتقدمة')); ?>
...
<?php endif; ?><?php /**PATH /workspace/final-project/resources/views/pages/home.blade.php ENDPATH**/ ?>