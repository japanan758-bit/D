<x-layouts.app title="آراء المرضى" description="تعرف على تجارب وآراء مرضانا الكرام في عيادة د. عبدالناصر الأخصور">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <p class="text-xl text-blue-100 max-w-3xl mx-auto">
                {{ __('تعرف على تجارب مرضانا الكرام ونتائج العلاج التي حققوها مع د. عبدالناصر الأخصور') }}
            </p>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600">{{ __('متوسط التقييم') }}</p>
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600">{{ __('تقييم من المرضى') }}</p>
            </div>
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600">{{ __('رضا المرضى') }}</p>
            </div>
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600">{{ __('عام خبرة') }}</p>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                {{ __('تجارب حقيقية من مرضانا الكرام الذين خضعوا للعلاج في عيادتنا') }}
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 shadow-lg">
                ...
                <p class="text-gray-700 mb-4">
                    "{{ __('د. عبدالناصر طبيب ممتاز جداً، كان تشخيصه دقيقاً وعلاجي للمياه البيضاء مذهل. الآن أرى بوضوح تام!') }}"
                </p>
            ...
            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 shadow-lg">
                ...
                <p class="text-gray-700 mb-4">
                    "{{ __('أطفالنا الثلاثة عندهم حول، والآن بعد جراحة د. عبدالناصر أصبح بصرهم طبيعياً تماماً. شكراً لك دكتور!') }}"
                </p>
                <div class="flex items-center text-sm text-gray-500">
                    <svg class="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"/>
            ...
            <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 shadow-lg">
                ...
                <p class="text-gray-700 mb-4">
                    "{{ __('كنت أعاني من مشاكل في الشبكية، والآن بعد العلاج بالليزر مع د. عبدالناصر تحسنت رؤيتي كثيراً. врач ممتاز!') }}"
                </p>
                <div class="flex items-center text-sm text-gray-500">
                    <svg class="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"/>
            ...
            <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-6 shadow-lg">
                ...
                <p class="text-gray-700 mb-4">
                    "{{ __('العيادة نظيفة جداً والطاقم الطبي محترف. د. عبدالناصر شرح لي العلاج بوضوح وكنت مطمئنة طوال الوقت.') }}"
                </p>
                <div class="flex items-center text-sm text-gray-500">
                    <svg class="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"/>
            ...
            <div class="bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl p-6 shadow-lg">
                ...
                <p class="text-gray-700 mb-4">
                    "{{ __('أخيراً وجدت دكتور يفهم حالتي! علاج الجلوكوما تم بنجاح ونصحني د. عبدالناصر بالعناية المستمرة.') }}"
                </p>
                <div class="flex items-center text-sm text-gray-500">
                    <svg class="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"/>
            ...
            <div class="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl p-6 shadow-lg">
                ...
                <p class="text-gray-700 mb-4">
                    "{{ __('كنت خائفة جداً من العملية، لكن د. عبدالناصر طمأنني وشرح كل شيء بالتفصيل. العملية تمت بنجاح تام!') }}"
                </p>
                <div class="flex items-center text-sm text-gray-500">
                    <svg class="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"/>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                {{ __('أمثلة حقيقية على نتائج علاج مرضانا الكرام') }}
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-4">
                    <h3 class="text-xl font-bold">{{ __('جراحة المياه البيضاء') }}</h3>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="bg-gradient-to-r from-green-600 to-green-700 text-white p-4">
                    <h3 class="text-xl font-bold">{{ __('علاج الحول') }}</h3>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="bg-gradient-to-r from-purple-600 to-purple-700 text-white p-4">
                    <h3 class="text-xl font-bold">{{ __('علاج الجلوكوما') }}</h3>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                {{ __('استمع إلى شهادات مرضانا مباشرة') }}
            </p>
        </div>
...
<section class="py-20 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-3xl lg:text-4xl font-bold mb-6">{{ __('كن أحد مرضانا الراضين') }}</h2>
        <p class="text-xl text-blue-100 mb-8">
            {{ __('انضم إلى قائمة مرضانا الذين حصلوا على أفضل رعاية طبية وحققوا نتائج مذهلة') }}
        </p>
